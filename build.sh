...
mkdir -p output/template/$APP_NAME/app/native/
...
cp -r template/* output/template/$APP_NAME/app/native/
cd output
find ./ -name .svn -exec rm -rf {} \;
tar cvzf xexplorer.tar.gz app conf webroot php template
